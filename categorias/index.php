...
<script>
$(function() {
	jQuery("#categoriasGrid").jqGrid({
			url:'ajaxListarCategorias.php',
			editurl:'modeloAction.php',
            datatype:'json',
            mtype:'GET',
            jsonReader:
				{'repeatitems':false},
            pager:'#categoriasPagerGrid',
            rowNum:10,
            rowList:
            ...
            forceFit:true,
            hidegrid:false,
            sortname:'NomeCategoria',
            sortorder:'asc',
			caption: "Categorias",
            colModel:[
                {label:'Cód.',width:60,align:'center',name:'idCategoria'},
				{label:'Nome da Categoria',width:200,align:'left',name:'nomeCategoria'}
            ] 
        });
	jQuery("#categoriasGrid").jqGrid('navGrid', '#categoriasPagerGrid', {del:false,add:false,edit:false,search:false,refresh:true} );
	
	//cadastro de categoria
	$("#btnCadastrar").click(function(){
		window.location = "categoriaCad.php";				   
	})
...
<table id="categoriasGrid" ></table>
<div id="categoriasPagerGrid"></div>
